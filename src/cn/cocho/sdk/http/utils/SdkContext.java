...
//        commonAttributesJson = JsonUtilSdk.toJSONString(commonAttributes);
        commonAttributesJson = JsonUtilSdk.toJson(commonAttributes);
    }
...
//			String attributes = SharedPreferenceUtils.getMemory(SdkConstants.SDK_COMMON_ATTRIBUES, "", String.class);
            if (StringUtilsSdk.isNotBlank(commonAttributesJson)) {
                Type type = new TypeToken<HashMap<String, Object>>() {
                }.getType();
                Map<String, Object> attributes = JsonUtilSdk.toObject(commonAttributesJson, type);
                if (attributes != null) {
